...
/**
 * Provides a form for reverting a Best Friends revision.
 *
 * @ingroup my_best_friends
 */
class FriendsRevisionRevertForm extends ConfirmFormBase {
  ...
  /**
   * Constructs a new FriendsRevisionRevertForm.
   *
  ...
  public function getFormId() {
    return 'friends_revision_revert_confirm';
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('content')->notice('Best Friends: reverted %title revision %revision.', ['%title' => $this->revision->label(), '%revision' => $this->revision->getRevisionId()]);
    drupal_set_message(t('Best Friends %title has been reverted to the revision from %revision-date.', ['%title' => $this->revision->label(), '%revision-date' => $this->dateFormatter->format($original_revision_timestamp)]));
   ...
   *
   * @param \Drupal\my_best_friends\Entity\FriendsInterface $revision
